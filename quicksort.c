//
// Created by evergreenis on 06/11/24.
//
...
{
    if(inicio < fim) // se o indice inicial é menor do que o índice final
    {
...
void initial_quick(int vet[], int inicio, int fim){
    srand(time(NULL));

    quick_sort(vet, inicio, fim);
}